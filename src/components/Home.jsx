        ...
        <div>
            <div className='flex justify-center items-center mt-[10%]'>
                <div className='text-center'>
                    ...
                    <button onClick={toggleReg} className='border-[3px] text-[#101656] border-[#101656] bg-white p-2 pl-5 pr-5 text-2xl m-3 hover:bg-[#101656] hover:text-[white] rounded-lg font-semibold'>Register</button>
                </div>
            </div>
