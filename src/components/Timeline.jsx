...
const EventTimeline = () => {
  return (
    <section className="bg-transparent text-white py-12 px-4 max-w-6xl mx-auto">
      ...
      <div className='w-[10%] items-center justify-center mb-3 bg-blue-950 h-1 m-3 ml-[45%] mb-5'></div>
            ...
            return (
              ...
              >
                <div className={`w-full md:w-1/2 ${isLeft ? "md:pr-8" : "md:pl-8"} mb-6 md:mb-0`}>
                  <div className="bg-blue-950 border border-white rounded-lg p-5 shadow-lg">
